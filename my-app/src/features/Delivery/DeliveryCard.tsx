...
export default function DeliveryCard({ CustomerName, CustomerPhone, CustomerAddress, OrderId, OrderTime, OrderCreationTime, PizzaCount, TotalPrice  }:   DeliveryDetails) {
